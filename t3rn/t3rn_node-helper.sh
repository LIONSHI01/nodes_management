...
function execute_script() {
    ...
    # 下载文件
    echo "正在下载 executor-linux-v0.42.0.tar.gz..."
    wget https://github.com/t3rn/executor-release/releases/download/v0.42.0/executor-linux-v0.42.0.tar.gz
    ...
    # 解压文件到当前目录
    echo "正在解压文件..."
    tar -xvzf executor-linux-v0.42.0.tar.gz
    ...
    # 删除压缩文件
    echo "删除压缩包..."
    rm executor-linux-v0.42.0.tar.gz
